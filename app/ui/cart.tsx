...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      {/* Header */}
      <div className="flex items-center px-4 sm:px-6 lg:px-8 py-4 border-b bg-white">
        <button className="mr-4 lg:hidden">
          <ArrowLeftIcon className="w-6 h-6" />
        </button>
        <h1 className="text-2xl font-bold flex-1 text-center lg:text-left mr-10 lg:mr-0">
          My Bag
        </h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            {/* Bottom Navigation */}
            <div className="flex items-center justify-around border-t py-3 bg-white lg:hidden">
              ...
              <button className="flex flex-col items-center gap-1 text-black">
                <ShoppingBagIcon className="w-6 h-6 fill-current" />
