      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col col-span-1 md:col-span-1">
            ...
            <div className="flex gap-5">
              <a href="#" className="text-stone hover:text-cream transition-colors">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/home" className="text-sm text-stone hover:text-cream transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center border-t border-stone/20 pt-8 gap-4">
          <p className="text-xs text-stone">
            &copy; 2024 Gabi Fixes. All rights reserved.
          </p>
