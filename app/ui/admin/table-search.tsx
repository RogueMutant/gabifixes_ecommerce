...
export default function TableSearch({ placeholder }: { placeholder: string }) {
  ...
  return (
    <div className="relative flex flex-1 flex-shrink-0">
      ...
      <input
        className="peer block w-full rounded-md border border-gray-200 dark:border-gray-700 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
